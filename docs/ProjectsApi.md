...
with Phrase.ApiClient(configuration) as api_client:
    ...
    api_instance = Phrase.ProjectsApi(api_client)
    project_create_parameters = Phrase.ProjectCreateParameters() # ProjectCreateParameters | 
...
with Phrase.ApiClient(configuration) as api_client:
    ...
    api_instance = Phrase.ProjectsApi(api_client)
    id = 'id_example' # str | ID
project_update_parameters = Phrase.ProjectUpdateParameters() # ProjectUpdateParameters | 
x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional) (optional)
