...
with Phrase.ApiClient(configuration) as api_client:
    ...
    api_instance = Phrase.SpacesApi(api_client)
    account_id = 'account_id_example' # str | Account ID
space_create_parameters = Phrase.SpaceCreateParameters() # SpaceCreateParameters | 
...
with Phrase.ApiClient(configuration) as api_client:
    ...
    account_id = 'account_id_example' # str | Account ID
id = 'id_example' # str | ID
space_update_parameters = Phrase.SpaceUpdateParameters() # SpaceUpdateParameters | 
x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional) (optional)
...
spaces_projects_create_parameters = Phrase.SpacesProjectsCreateParameters() # SpacesProjectsCreateParameters | 
x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional) (optional)
