...
import Phrase
from Phrase.models.job_locale import JobLocale  # noqa: E501
...
class TestJobLocale(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = Phrase.models.job_locale.JobLocale()  # noqa: E501
        if include_optional :
            return JobLocale(
                id = '0', 
                job = Phrase.models.job_preview.job_preview(
                    id = '0', 
                    name = '0', 
                    state = '0', ), 
                locale = {"id":"abcd1234cdef1234abcd1234cdef1234","name":"English","code":"en-GB"}, 
                users = [
                    Phrase.models.user_preview.user_preview(
                        id = '0', 
                        username = '0', 
                        name = '0', )
                    ]
