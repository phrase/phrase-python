...
class JobTemplateUpdateParameters(object):
    ...
    def owner_id(self, owner_id):
        """Sets the owner_id of this JobTemplateUpdateParameters.

        Code of the account member to set as the job template owner. The referenced user must also be a member of the project; passing the code of an account member who is not a project member returns a 404. Pass an empty string to clear a previously set owner; when blank, jobs created from this template will default to assigning the job creator as owner.   # noqa: E501

        :param owner_id: The owner_id of this JobTemplateUpdateParameters.  # noqa: E501
        :type: str
        """
