...
class LocalesApi(object):
    ...
    def locale_download(self, project_id, id, **kwargs):  # noqa: E501
        ...
        :param bool filter_by_prefix: Only download translation keys containing the prefix specified by `translation_key_prefix`, and remove that prefix from the generated file. Requires `translation_key_prefix` to be set.
    ...
    def locale_download_with_http_info(self, project_id, id, **kwargs):  # noqa: E501
        ...
        if 'use_locale_fallback' in local_var_params and local_var_params['use_locale_fallback'] is not None:  # noqa: E501
            query_params.append(('use_locale_fallback', local_var_params['use_locale_fallback']))  # noqa: E501
        if 'fallback_for_unverified_translations' in local_var_params and local_var_params['fallback_for_unverified_translations'] is not None:  # noqa: E501
            query_params.append(('fallback_for_unverified_translations', local_var_params['fallback_for_unverified_translations']))  # noqa: E501
