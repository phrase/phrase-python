...
# **screenshot_create**
> screenshot_create(project_id, screenshot_create_parameters, x_phrase_app_otp=x_phrase_app_otp)
...
with Phrase.ApiClient(configuration) as api_client:
    ...
    api_instance = Phrase.ScreenshotsApi(api_client)
    project_id = 'project_id_example' # str | Project ID
screenshot_create_parameters = Phrase.ScreenshotCreateParameters() # ScreenshotCreateParameters | 
...
with Phrase.ApiClient(configuration) as api_client:
    ...
    project_id = 'project_id_example' # str | Project ID
id = 'id_example' # str | ID
screenshot_update_parameters = Phrase.ScreenshotUpdateParameters() # ScreenshotUpdateParameters | 
x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional) (optional)
