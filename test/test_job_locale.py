...
import phrase_api
from phrase_api.models.job_locale import JobLocale  # noqa: E501
...
class TestJobLocale(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = phrase_api.models.job_locale.JobLocale()  # noqa: E501
        if include_optional :
            return JobLocale(
                id = '0', 
                job = phrase_api.models.job_preview.job_preview(
                    id = '0', 
                    name = '0', 
                    state = '0', ), 
