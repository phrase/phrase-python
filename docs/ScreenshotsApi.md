...
screenshot_create_parameters = phrase-api.ScreenshotCreateParameters() # ScreenshotCreateParameters | 
...
with phrase-api.ApiClient(configuration) as api_client:
    ...
    project_id = 'project_id_example' # str | Project ID
id = 'id_example' # str | ID
screenshot_update_parameters = phrase-api.ScreenshotUpdateParameters() # ScreenshotUpdateParameters | 
x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional) (optional)
