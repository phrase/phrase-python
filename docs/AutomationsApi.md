...
# **automation_activate**
> Automation automation_activate(account_id, id, x_phrase_app_otp=x_phrase_app_otp)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Activate an automation
        api_response = api_instance.automation_activate(account_id, id, x_phrase_app_otp=x_phrase_app_otp)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AutomationsApi->automation_activate: %s\n" % e)
```
...
# **automation_create**
> Automation automation_create(account_id, automations_create_parameters, x_phrase_app_otp=x_phrase_app_otp)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    api_instance = phrase_api.AutomationsApi(api_client)
    account_id = 'account_id_example' # str | Account ID (required)
    automations_create_parameters = phrase_api.AutomationsCreateParameters() # AutomationsCreateParameters |  (required)
    x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional)

    try:
        # Create an automation
        api_response = api_instance.automation_create(account_id, automations_create_parameters, x_phrase_app_otp=x_phrase_app_otp)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AutomationsApi->automation_create: %s\n" % e)
```
...
> Automation automation_deactivate(account_id, id, x_phrase_app_otp=x_phrase_app_otp)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Deactivate an automation
        api_response = api_instance.automation_deactivate(account_id, id, x_phrase_app_otp=x_phrase_app_otp)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AutomationsApi->automation_deactivate: %s\n" % e)
```
...
# **automation_delete**
> automation_delete(account_id, id, x_phrase_app_otp=x_phrase_app_otp)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Destroy automation
        api_instance.automation_delete(account_id, id, x_phrase_app_otp=x_phrase_app_otp)
    except ApiException as e:
        print("Exception when calling AutomationsApi->automation_delete: %s\n" % e)
```
...
# **automation_show**
> Automation automation_show(account_id, id, x_phrase_app_otp=x_phrase_app_otp)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a single automation
        api_response = api_instance.automation_show(account_id, id, x_phrase_app_otp=x_phrase_app_otp)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AutomationsApi->automation_show: %s\n" % e)
```
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    account_id = 'account_id_example' # str | Account ID (required)
    id = 'id_example' # str | ID (required)
    automations_create_parameters1 = phrase_api.AutomationsCreateParameters1() # AutomationsCreateParameters1 |  (required)
    x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional)

    try:
        # Update an automation
        api_response = api_instance.automation_update(account_id, id, automations_create_parameters1, x_phrase_app_otp=x_phrase_app_otp)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AutomationsApi->automation_update: %s\n" % e)
```
...
# **automations_list**
> List[Automation] automations_list(account_id, x_phrase_app_otp=x_phrase_app_otp, page=page, per_page=per_page)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    try:
        # List automations
        api_response = api_instance.automations_list(account_id, x_phrase_app_otp=x_phrase_app_otp, page=page, per_page=per_page)
        pprint(api_response)
    except ApiException as e:
