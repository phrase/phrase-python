...
# **styleguide_create**
> StyleguideDetails styleguide_create(project_id, styleguide_create_parameters, x_phrase_app_otp=x_phrase_app_otp)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    api_instance = phrase_api.StyleGuidesApi(api_client)
    project_id = 'project_id_example' # str | Project ID (required)
    styleguide_create_parameters = phrase_api.StyleguideCreateParameters() # StyleguideCreateParameters |  (required)
    x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional)

    try:
        # Create a style guide
        api_response = api_instance.styleguide_create(project_id, styleguide_create_parameters, x_phrase_app_otp=x_phrase_app_otp)
        pprint(api_response)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    project_id = 'project_id_example' # str | Project ID (required)
    id = 'id_example' # str | ID (required)
    styleguide_update_parameters = phrase_api.StyleguideUpdateParameters() # StyleguideUpdateParameters |  (required)
    x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional)
