...
class RepoSyncsApi(object):
    ...
    def repo_sync_create(self, account_id, repo_sync_create_parameters, **kwargs):  # noqa: E501
        """Create a Repo Sync  # noqa: E501

        Create a new Repo Sync.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_sync_create(account_id, repo_sync_create_parameters, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str account_id: Account ID (required)
        :param RepoSyncCreateParameters repo_sync_create_parameters: (required)
        :param str x_phrase_app_otp: Two-Factor-Authentication token (optional)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.repo_sync_create_with_http_info(account_id, repo_sync_create_parameters, **kwargs)  # noqa: E501

    def repo_sync_create_with_http_info(self, account_id, repo_sync_create_parameters, **kwargs):  # noqa: E501
        """Create a Repo Sync  # noqa: E501

        Create a new Repo Sync.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_sync_create_with_http_info(account_id, repo_sync_create_parameters, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_sync_create" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'account_id' is set
        if self.api_client.client_side_validation and ('account_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['account_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `account_id` when calling `repo_sync_create`")  # noqa: E501
        # verify the required parameter 'repo_sync_create_parameters' is set
        if self.api_client.client_side_validation and ('repo_sync_create_parameters' not in local_var_params or  # noqa: E501
                                                        local_var_params['repo_sync_create_parameters'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `repo_sync_create_parameters` when calling `repo_sync_create`")  # noqa: E501
        ...
        body_params = None
        if 'repo_sync_create_parameters' in local_var_params:
            body_params = local_var_params['repo_sync_create_parameters']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/accounts/{account_id}/repo_syncs', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def repo_sync_import_with_http_info(self, account_id, id, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'repo_sync_import_parameters' in local_var_params:
            body_params = local_var_params['repo_sync_import_parameters']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
