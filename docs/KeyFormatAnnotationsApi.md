# phrase_api.KeyFormatAnnotationsApi
...
> List[KeyFormatAnnotationsList200ResponseInner] key_format_annotations_list(project_id, id, x_phrase_app_otp=x_phrase_app_otp, branch=branch)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    api_instance = phrase_api.KeyFormatAnnotationsApi(api_client)
    ...
    try:
        # List format annotations for a key
        api_response = api_instance.key_format_annotations_list(project_id, id, x_phrase_app_otp=x_phrase_app_otp, branch=branch)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling KeyFormatAnnotationsApi->key_format_annotations_list: %s\n" % e)
```
