...
with phrase-api.ApiClient(configuration) as api_client:
    ...
    api_instance = phrase-api.GlossaryApi(api_client)
    account_id = 'account_id_example' # str | Account ID
glossary_create_parameters = phrase-api.GlossaryCreateParameters() # GlossaryCreateParameters | 
x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional) (optional)
...
with phrase-api.ApiClient(configuration) as api_client:
    ...
    account_id = 'account_id_example' # str | Account ID
id = 'id_example' # str | ID
glossary_update_parameters = phrase-api.GlossaryUpdateParameters() # GlossaryUpdateParameters | 
x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional) (optional)
