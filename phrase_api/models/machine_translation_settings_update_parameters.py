...
class MachineTranslationSettingsUpdateParameters(object):
    ...
    def __init__(self, default_service=None, local_vars_configuration=None):  # noqa: E501
        """MachineTranslationSettingsUpdateParameters - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MachineTranslationSettingsUpdateParameters):
            return False
