...
# **documents_list**
> list[Document] documents_list(x_phrase_app_otp=x_phrase_app_otp, page=page, per_page=per_page)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    try:
        # List documents
        api_response = api_instance.documents_list(x_phrase_app_otp=x_phrase_app_otp, page=page, per_page=per_page)
        pprint(api_response)
