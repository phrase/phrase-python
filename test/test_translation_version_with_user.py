...
import Phrase
from Phrase.models.translation_version_with_user import TranslationVersionWithUser  # noqa: E501
...
class TestTranslationVersionWithUser(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = Phrase.models.translation_version_with_user.TranslationVersionWithUser()  # noqa: E501
        if include_optional :
            return TranslationVersionWithUser(
                ...
                user = Phrase.models.user_preview.user_preview(
                    id = '0', 
                    username = '0', 
                    name = '0', )
            )
