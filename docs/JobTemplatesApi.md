...
# **job_template_create**
> object job_template_create(project_id, job_template_create_parameters, x_phrase_app_otp=x_phrase_app_otp)
...
# **job_template_show**
> object job_template_show(project_id, id, x_phrase_app_otp=x_phrase_app_otp, branch=branch)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a single job template
        api_response = api_instance.job_template_show(project_id, id, x_phrase_app_otp=x_phrase_app_otp, branch=branch)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling JobTemplatesApi->job_template_show: %s\n" % e)
```
...
# **job_template_update**
> object job_template_update(project_id, id, job_template_update_parameters, x_phrase_app_otp=x_phrase_app_otp)
