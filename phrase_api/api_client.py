...
import phrase_api.models
from phrase_api import rest
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/3.12.1/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(phrase_api.models, klass)
    ...
    def __deserialize_file(self, response):
        ...
        if six.PY3:
            with open(path, "w", encoding=response.getencoding()) as f:
                f.write(response.data)
        else:
            with open(path, "wb", encoding=response.getencoding()) as f:
                f.write(response.data)
