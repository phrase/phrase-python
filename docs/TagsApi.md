...
# **tags_list**
> List[Tag] tags_list(project_id, x_phrase_app_otp=x_phrase_app_otp, page=page, per_page=per_page, exclude_system_tags=exclude_system_tags, branch=branch, q=q)
...
with phrase_api.ApiClient(configuration) as api_client:
    ...
    try:
        # List tags
        api_response = api_instance.tags_list(project_id, x_phrase_app_otp=x_phrase_app_otp, page=page, per_page=per_page, exclude_system_tags=exclude_system_tags, branch=branch, q=q)
        pprint(api_response)
    except ApiException as e:
