...
with Phrase.ApiClient(configuration) as api_client:
    ...
    api_instance = Phrase.AuthorizationsApi(api_client)
    authorization_create_parameters = Phrase.AuthorizationCreateParameters() # AuthorizationCreateParameters | 
...
with Phrase.ApiClient(configuration) as api_client:
    ...
    api_instance = Phrase.AuthorizationsApi(api_client)
    id = 'id_example' # str | ID
authorization_update_parameters = Phrase.AuthorizationUpdateParameters() # AuthorizationUpdateParameters | 
x_phrase_app_otp = 'x_phrase_app_otp_example' # str | Two-Factor-Authentication token (optional) (optional)
