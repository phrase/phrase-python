...
class AutomationsCreateParameters(object):
    ...
    @property
    def name(self):
        """Gets the name of this AutomationsCreateParameters.  # noqa: E501

        name of the automation  # noqa: E501

        :return: The name of this AutomationsCreateParameters.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AutomationsCreateParameters.

        name of the automation  # noqa: E501

        :param name: The name of this AutomationsCreateParameters.  # noqa: E501
        :type: str
        """
    ...
    @property
    def trigger(self):
        """Gets the trigger of this AutomationsCreateParameters.  # noqa: E501


        :return: The trigger of this AutomationsCreateParameters.  # noqa: E501
        :rtype: str
        """
    ...
    def trigger(self, trigger):
        """Sets the trigger of this AutomationsCreateParameters.


        :param trigger: The trigger of this AutomationsCreateParameters.  # noqa: E501
        :type: str
        """
    ...
    def job_template_id(self):
        """Gets the job_template_id of this AutomationsCreateParameters.  # noqa: E501

        id of job template that the automation uses to create jobs from  # noqa: E501

        :return: The job_template_id of this AutomationsCreateParameters.  # noqa: E501
        :rtype: str
        """
    ...
    def job_template_id(self, job_template_id):
        """Sets the job_template_id of this AutomationsCreateParameters.

        id of job template that the automation uses to create jobs from  # noqa: E501

        :param job_template_id: The job_template_id of this AutomationsCreateParameters.  # noqa: E501
        :type: str
        """
    ...
    def status_filters(self):
        """Gets the status_filters of this AutomationsCreateParameters.  # noqa: E501

        Translation states used when selecting keys for a job.  States are derived from associated translations, not the keys themselves.  When review workflow is enabled, `ready_for_review` is internally treated as `translated`.   # noqa: E501

        :return: The status_filters of this AutomationsCreateParameters.  # noqa: E501
        :rtype: List[str]
        """
    ...
    def status_filters(self, status_filters):
        """Sets the status_filters of this AutomationsCreateParameters.

        Translation states used when selecting keys for a job.  States are derived from associated translations, not the keys themselves.  When review workflow is enabled, `ready_for_review` is internally treated as `translated`.   # noqa: E501

        :param status_filters: The status_filters of this AutomationsCreateParameters.  # noqa: E501
        :type: List[str]
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this AutomationsCreateParameters.  # noqa: E501

        used to filter which keys are added to jobs  # noqa: E501

        :return: The tags of this AutomationsCreateParameters.  # noqa: E501
        :rtype: List[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this AutomationsCreateParameters.

        used to filter which keys are added to jobs  # noqa: E501

        :param tags: The tags of this AutomationsCreateParameters.  # noqa: E501
        :type: List[str]
        """
    ...
    def cron_schedule(self):
        """Gets the cron_schedule of this AutomationsCreateParameters.  # noqa: E501

        along with time_zone, specifies when the scheduled automation is supposed to run  # noqa: E501

        :return: The cron_schedule of this AutomationsCreateParameters.  # noqa: E501
        :rtype: str
        """
    ...
    def cron_schedule(self, cron_schedule):
        """Sets the cron_schedule of this AutomationsCreateParameters.

        along with time_zone, specifies when the scheduled automation is supposed to run  # noqa: E501

        :param cron_schedule: The cron_schedule of this AutomationsCreateParameters.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time_zone(self):
        """Gets the time_zone of this AutomationsCreateParameters.  # noqa: E501

        along with cron_schedule, specifies when the scheduled automation is supposed to run  # noqa: E501

        :return: The time_zone of this AutomationsCreateParameters.  # noqa: E501
        :rtype: str
        """
    ...
    def time_zone(self, time_zone):
        """Sets the time_zone of this AutomationsCreateParameters.

        along with cron_schedule, specifies when the scheduled automation is supposed to run  # noqa: E501

        :param time_zone: The time_zone of this AutomationsCreateParameters.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AutomationsCreateParameters):
            return False
