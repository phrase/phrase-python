...
class MembersApi(object):
    ...
    def member_update_settings(self, project_id, id, member_update_settings_parameters, **kwargs):  # noqa: E501
        ...
        :param str id: ID (required)
        :param MemberUpdateSettingsParameters member_update_settings_parameters: (required)
        :param str x_phrase_app_otp: Two-Factor-Authentication token (optional)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.member_update_settings_with_http_info(project_id, id, member_update_settings_parameters, **kwargs)  # noqa: E501
    ...
    def member_update_settings_with_http_info(self, project_id, id, member_update_settings_parameters, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(MemberProjectDetail, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = [
            'project_id',
            'id',
            'member_update_settings_parameters',
            'x_phrase_app_otp'
        ]
        all_params.extend(
            [
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method member_update_settings" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('project_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `project_id` when calling `member_update_settings`")  # noqa: E501
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `member_update_settings`")  # noqa: E501
        # verify the required parameter 'member_update_settings_parameters' is set
        if self.api_client.client_side_validation and ('member_update_settings_parameters' not in local_var_params or  # noqa: E501
                                                        local_var_params['member_update_settings_parameters'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `member_update_settings_parameters` when calling `member_update_settings`")  # noqa: E501
        ...
        body_params = None
        if 'member_update_settings_parameters' in local_var_params:
            body_params = local_var_params['member_update_settings_parameters']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='MemberProjectDetail',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def members_by_project(self, project_id, **kwargs):  # noqa: E501
        """List project members  # noqa: E501

        Get all members active in the project. Access token scope must include `read`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.members_by_project(project_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str project_id: Project ID (required)
        :param str x_phrase_app_otp: Two-Factor-Authentication token (optional)
        :param str q: Specify a query to search for members by name or email (including wildcards).
        :param str job_id: Filter members to those assigned to the job identified by this id.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.members_by_project_with_http_info(project_id, **kwargs)  # noqa: E501

    def members_by_project_with_http_info(self, project_id, **kwargs):  # noqa: E501
        """List project members  # noqa: E501

        Get all members active in the project. Access token scope must include `read`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.members_by_project_with_http_info(project_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(List[ProjectMember], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method members_by_project" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'project_id' is set
        if self.api_client.client_side_validation and ('project_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['project_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `project_id` when calling `members_by_project`")  # noqa: E501
